...
const SLIDES_TEXT = [
  {
    subtitle: "Pune's Beloved North Indian Restaurant • 4.2★ (3,160 reviews)",
    title: "Hotel Shivanjali",
    caption: "Curry, tandoori & classic North Indian dishes in Pashan"
  },
  {
    subtitle: "Biryani • Butter Chicken • Kung Pao Chicken",
    title: "Signature Flavours",
    caption: "From rich curries to Chinese & vegetarian options — something for everyone"
  },
  {
    subtitle: "Rooftop Bar • Family Dining • Banquets",
    title: "Dine & Celebrate",
    caption: "Elegant rooftop dining, banquet halls for celebrations & cozy indoor seating"
  }
];
              ...
              <div className={`layer-content-${index} absolute inset-0 flex flex-col items-center justify-between select-none pb-24 pt-[18vh] md:pt-[22vh]`}>
                ...
                <div className="w-full px-4 text-center">
                  <h1 className="font-accent text-[12vw] md:text-[6.5vw] text-white font-normal tracking-wide drop-shadow-[0_4px_20px_rgba(0,0,0,0.85)] select-all leading-tight">
                    {index === 0 ? (
                      <>
                        Hotel <span className="italic text-gold">Shivanjali</span>
                      </>
                    ) : index === 1 ? (
                      <>
                        Signature <span className="italic text-gold">Flavours</span>
                      </>
                    ) : (
                      <>
                        Dine & <span className="italic text-gold">Celebrate</span>
                      </>
                    )}
                  </h1>
